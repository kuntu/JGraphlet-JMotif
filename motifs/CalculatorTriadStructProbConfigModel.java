 ...
 * 		 probNull = \prod_{j=0}^{O_u-1}(1 - \frac{I_v}{numEdge - j}) 
 * 				  \approx 1 - \frac{O_u* I_v}{numEdge}
 * @author Captor
 *
 */
public class CalculatorTriadStructProbConfigModel extends TriadStructProbability implements StructProbFromDegreeEdgeCalculator {
